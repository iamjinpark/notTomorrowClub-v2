  ...
  return (
    <>
      ...
      <div className="absolute top-[2.0625rem] left-[1.8125rem] w-[18rem] text-[#2b2b2b]">
        <p className="font-roboto text-[1.375rem] leading-[1.125rem]">
          Welcome to NTC CLUB
        </p>
        <p className="font-roboto mt-[1.25rem] text-[1rem] leading-[1.23]">
      ...
      <div className="font-roboto absolute top-[16.875rem] left-[37.6875rem] flex items-center gap-[0.9375rem] text-[1rem] leading-[1.23] text-[#2b2b2b]">
        {SIDES.map((s) => (
          <button
            ...
            className={side === s.value ? "underline" : "hover:underline"}
          >
            {s.label}
          </button>
        ))}
      ...
      {/* Grade — 문서 (28, 481) */}
      <div className="font-roboto absolute top-[19.1875rem] left-[1.75rem] w-[16.0625rem] text-[1.375rem] leading-[1.23] text-[#d5d5d5]">
        <p>Grade:</p>
        <p>{card.grade}</p>
      </div>
